...
import ConstellationDetail from '../constellations/ConstellationDetail';
...
export default function ConstellationPage() {
  ...
  const constellation = constellations[parseInt(id)];

  useEffect(() => {
    if (!constellation) navigate('/');
  }, [constellation, navigate]);
